...
public class Main {
    ...
    /**
     * Evita mensajes internos extensos de JInput en la consola de entrega.
     */
    private static void silenciarLogsJInput() {
        ...
        Logger loggerEntorno = Logger.getLogger("net.java.games.input.ControllerEnvironment");
        loggerEntorno.setUseParentHandlers(false);
        loggerEntorno.setLevel(Level.OFF);
    }
}
